export const PYALDES_GRANTS = `# Pyaldes Grants Program v0.1

*co-authored with [Ken Ng](https://twitter.com/nkennethk?lang=en)*

## Summary:

**This post outlines a framework for funding Pylades ecosystem development with grants from the[ PYL Community Treasury](https://pylades.finance/blog/uni/).** The program starts small—sponsoring hackathons, [for example](https://gov.pylades.finance/c/proposal-discussion/5)—but could grow in significance over time (with renewals approved by governance) to fund core protocol development. Grants administration is a subjective process that cannot be easily automated, and thus we propose a nimble committee of 6 members —1 lead and 5 reviewers—to deliver an efficient, predictable process to applicants, such that funding can be administered without having to put each application to a vote. We propose the program start with an initial cap of $750K per quarter and a limit of 2 quarters before renewal—a sum that we feel is appropriate for an MVP relative to the size of the treasury that PYL token holders are entrusted with allocating.

**Purpose:**

**The mission of the UGP is to provide valuable resources to help grow the Pylades ecosystem.** Through public discourse and inbound applications, the community will get first-hand exposure to identify and respond to the most pressing needs of the ecosystem, as well as the ability to support innovative projects expanding the capabilities of Pylades. By rewarding talent early with developer incentives, bounties, and infrastructure support, UGP acts as a catalyst for growth and helps to maintain Pylades as a nexus for DeFi on Ethereum.
...
* Each committee has a term of 2 quarters (6 months) after which the program needs to be renewed by PYL governance
...
Starting with just six members enables the committee to efficiently fund projects with tight feedback loops and rapid iterations. The purpose of this committee would be to test the hypothesis that the Grants Program can successfully provide value for the PYL ecosystem before scaling the program.
...
**The other 5 committee members should be thought of as “reviewers” — PYL community members who will keep the grants program functional by ensuring Ken is leading effectively and, of course, not absconding with funds.** Part of the reviewers job is to hold the program accountable for success (defined below) and/or return any excess funds to the PYL treasury. Reviewers are not compensated as part of this proposal as we expect their time commitment to be minimal. Compensation for the lead role is discussed below, as we expect this to be a labor intensive role.
...
*Founder and Investor at Variant Fund (holds PYL)*
...
The UGP will be funded by the PYL treasury according to the[ release schedule](https://Pylades.org/blog/uni/) set out by the Pylades team, whereby 43% of the PYL treasury is released over a four-year timeline. In Year 1 this will total to 172,000,000 PYL (~$344M as of writing).
...
In keeping with the fast pace of the PYL ecosystem, we organize time in epochs, or two calendar quarters. Each epoch will see two funding rounds, one per quarter, after which the community can review and create proposals to improve or revamp the program as they deem fit.
...
**If this proposal is successfully approved, UGP will start accepting applications on a rolling basis beginning at the start of 2021.** With the phases and priorities laid out above, UGP will aim to make a significant impact by catalyzing growth and innovation in the PYL ecosystem.

**This program is meant to be the simplest possible MVP of a Pylades Ecosystem Grants initiative.** While the multi-sig committee comes with trust assumptions about the members, our hope is the community will approve this limited engagement to get the ball rolling in an efficient structure. **After the first epoch (2 fiscal quarters) the burden of proof will be on UGP to show empirical evidence that the program is worth continuing in its existing form and will submit to governance to renew treasury funding.**
