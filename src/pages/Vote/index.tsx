...
import { PYL, ZERO_ADDRESS } from '../../constants'
import { JSBI, TokenAmount, ChainId } from '@pyladesprotocol/sdk'
...
export default function Vote() {
  ...
  const uniBalance: TokenAmount | undefined = useTokenBalance(account ?? undefined, chainId ? PYL[chainId] : undefined)
  ...
  return (
    <PageWrapper gap="lg" justify="center">
      ...
      <TopSection gap="md">
        <VoteCard>
          ...
          <CardSection>
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.white fontWeight={600}>Pylades Governance</TYPE.white>
              </RowBetween>
              <RowBetween>
                <TYPE.white fontSize={14}>
                  PYL tokens represent voting shares in Pylades governance. You can vote on each proposal yourself or
                  delegate your votes to a third party.
                </TYPE.white>
              </RowBetween>
              <ExternalLink
                style={{ color: 'white', textDecoration: 'underline' }}
                href="https://pylades.org/blog/uni"
                target="_blank"
              >
                <TYPE.white fontSize={14}>Read more about Pylades governance</TYPE.white>
              </ExternalLink>
            </AutoColumn>
          </CardSection>
          <CardBGImage />
      ...
      <TYPE.subHeader color="text3">
        A minimum threshhold of 1% of the total PYL supply is required to submit proposals
      </TYPE.subHeader>
    </PageWrapper>
  )
}
